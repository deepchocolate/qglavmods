...
setMethod('getCholeskyDefinitions', signature('Bivariate'),
          function (object) {
            ...
            latParmA1 <- getLatentParameterLabel(object@mod1, 'A')
            latParmC1 <- getLatentParameterLabel(object@mod1, 'A')
            latParmE1 <- getLatentParameterLabel(object@mod1, 'A')
            V1A <- paste0('V_A_', m1, ' := ', latParmA1, '^2')
            V1C <- paste0('V_C_', m1, ' := ', latParmC1, '^2')
            V1E <- paste0('V_E_', m1, ' := ', latParmE1)
            ...
            latParmA2 <- getLatentParameterLabel(object@mod2, 'A')
            latParmC2 <- getLatentParameterLabel(object@mod2, 'A')
            latParmE2 <- getLatentParameterLabel(object@mod2, 'A')
            V2A <- paste0('V_A_', m2, ' := ', latParmA2, '^2 + ', latParmA1, '_', m2, '^2')
            V2C <- paste0('V_C_', m2, ' := ', latParmC2, '^2 + ', latParmC1, '_', m2, '^2')
            V2E <- paste0('V_E_', m2, ' := ', latParmE2, ' + ', latParmE1, '_', m2)
