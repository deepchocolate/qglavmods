...
setMethod('getCholeskyDefinitions', signature('Bivariate'),
          function (object) {
            ...
            V2A <- paste0('V_A_', m2, ' := ', getLatentParameterLabel(object@mod2, 'A'), ' + ', getCorrParamLabel(object, 'A', object@mod1, object@mod2))
            V2C <- paste0('V_C_', m2, ' := ', getLatentParameterLabel(object@mod2, 'C'), ' + ', getCorrParamLabel(object, 'C', object@mod1, object@mod2))
            V2E <- paste0('V_E_', m2, ' := ', getLatentParameterLabel(object@mod2, 'E'), ' + ', getCorrParamLabel(object, 'E', object@mod1, object@mod2))
