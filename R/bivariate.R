...
setMethod('getCholeskyDefinitions', signature('Bivariate'),
          function (object) {
            ...
            latParmC1 <- getLatentParameterLabel(object@mod1, 'C')
            latParmE1 <- getLatentParameterLabel(object@mod1, 'E')
            ...
            latParmC2 <- getLatentParameterLabel(object@mod2, 'C')
            latParmE2 <- getLatentParameterLabel(object@mod2, 'E')
